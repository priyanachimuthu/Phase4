...
public class Amazon_class {
	...
	public static void beforeClass() throws Exception {
		...
		//driver.findElement(By.xpath("//android.widget.Button[@text='Wait']")).click();
		Thread.sleep(3000);
...
//com.amazon.mShop.android.shopping:id/rs_search_src_text
	driver.findElementByXPath("//android.widget.EditText[@resource-id='com.amazon.mShop.android.shopping:id/rs_search_src_text']").sendKeys("earphones with microphone");
	WebDriverWait wait = new WebDriverWait(driver, 80);
	wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.amazon.mShop.android.shopping:id/rs_search_src_text")));
	
	
		driver.findElement(By.id("com.amazon.mShop.android.shopping:id/rs_search_src_text")).click();
		Thread.sleep(3000);
		
		driver.findElement(By.id("com.amazon.mShop.android.shopping:id/rs_search_src_text")).sendKeys("panasonic earphones with microphone");
		Thread.sleep(4000);
		
	List<MobileElement> searchDd = driver.findElementsById("com.amazon.mShop.android.shopping:id/iss_search_dropdown_item_text");
        ...
        //Selection
      //  driver.findElement(By.xpath("//android.view.View[@content-desc=\"Panasonic ErgoFit Earbud Headphones with Microphone and Call Controller Compatible with iPhone, Android and Blackberry - RP-TCM125-AA - In-Ear (Metallic Blue), S/M/L Included 4.3 out of 5 stars 92,339\"]/android.view.View[1]")).click();
        List<MobileElement> searchFd = driver.findElementsById("com.amazon.mShop.android.shopping:id/mshop_webView_container");
	...
	//	driver.findElement(By.id("com.amazon.mShop.android.shopping:id/add-to-cart-button")).click();
		Thread.sleep(3000);
